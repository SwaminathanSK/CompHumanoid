...
def main(args):
    if args.with_full_model:
        env = HumanoidNumpyEnv('/home/swaminathan/git/CompHumanoid/humanoid-bench/humanoid_bench/assets/mjx/scene_test_mesh_collisions_hands_two_targets_pos.xml', task=args.task)
    else:
        env = HumanoidNumpyEnv('/home/swaminathan/git/CompHumanoid/humanoid-bench/humanoid_bench/assets/mjx/scene_mjx_feet_collisions_two_targets_pos.xml', task=args.task)
